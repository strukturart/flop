(function() {
    ...
    Vnode.normalizeChildren = function(input) {
        ...
        if (input.length) {
            ...
            for(var i = 0; i < input.length; i++)children0[i] = Vnode.normalize(input[i]);
        }
        return children0;
    };
    ...
    var hyperscriptVnode = function() {
        ...
        if (arguments.length === start + 1) {
            ...
            if (!Array.isArray(children1)) children1 = [
                children1
            ];
        } else {
            children1 = [];
        ...
        function createElement(parent, vnode3, hooks, ns, nextSibling) {
            ...
            if (!maybeSetContentEditable(vnode3)) {
                if (vnode3.text != null) {
                    ...
                    else vnode3.children = [
                        Vnode("#", undefined, undefined, vnode3.text, undefined, undefined), 
                    ];
                }
                if (vnode3.children != null) {
                    var children3 = vnode3.children;
     ...
     */ // This function diffs and patches lists of vnodes, both keyed and unkeyed.
        ...
        function updateElement(old, vnode3, hooks, ns) {
            ...
            if (!maybeSetContentEditable(vnode3)) {
                if (old.text != null && vnode3.text != null && vnode3.text !== "") {
                    ...
                    if (vnode3.text != null) vnode3.children = [
                        Vnode("#", undefined, undefined, vnode3.text, undefined, undefined), 
                    ];
        ...
        function moveChildToFrag(parent, frag, vnode3) {
            ...
            while(vnode3.dom != null && vnode3.dom.parentNode === parent){
                ...
                else if (vnode3.tag !== "[") // Don't recurse for text nodes *or* elements, just fragments
        ...
        function maybeSetContentEditable(vnode3) {
            if (vnode3.attrs == null || vnode3.attrs.contenteditable == null && vnode3.attrs.contentEditable == null // property
            ) return false;
            var children3 = vnode3.children;
        ...
        function onremove(vnode3) {
            ...
            if (typeof vnode3.tag !== "string") {
                ...
                var children3 = vnode3.children;
                if (Array.isArray(children3)) for(var i = 0; i < children3.length; i++){
                    var child = children3[i];
        ...
        function setAttrs(vnode3, attrs2, ns) {
            for(var key in attrs2)setAttr(vnode3, key, null, attrs2[key], ns);
        }
        ...
        function removeAttr(vnode3, key, old, ns) {
            ...
            else if (hasPropertyKey(vnode3, key, ns) && key !== "className" && !(key === "value" && (vnode3.tag === "option" || vnode3.tag === "select" && vnode3.dom.selectedIndex === -1 && vnode3.dom === activeElement())) && !(vnode3.tag === "input" && key === "type")) vnode3.dom[key] = null;
            else {
        ...
        function updateAttrs(vnode3, old, attrs2, ns) {
            if (attrs2 != null) for(var key in attrs2)setAttr(vnode3, key, old && old[key], attrs2[key], ns);
            var val;
            if (old != null) {
        ...
        function hasPropertyKey(vnode3, key, ns) {
            ...
            return ns === undefined && (vnode3.tag.indexOf("-") > -1 || vnode3.attrs != null && vnode3.attrs.is || key !== "href" && key !== "list" && key !== "form" && key !== "width" && key !== "height") && // Defer the property check until *after* we check everything.
            key in vnode3.dom;
        }
        //style
    ...
    var buildQueryString = function(object) {
        ...
        var args = [];
        for(var key21 in object)destructure(key21, object[key21]);
        return args.join("&");
    ...
    var assign = Object.assign || function(target, source) {
        if (source) Object.keys(source).forEach(function(key3) {
    ...
    var _18 = function($window, Promise, oncompletion) {
        ...
        function makeRequest(factory) {
            return function(url, args) {
                ...
                if (args.background === true) return promise11;
                var count = 0;
                function complete() {
                    if (--count === 0 && typeof oncompletion === "function") oncompletion();
                }
                return wrap(promise11);
        ...
        return {
            request: makeRequest(function(url, args, resolve, reject) {
                ...
                if (assumeJSON && body != null && !hasHeader(args, /^content0-type1$/i)) xhr.setRequestHeader("Content-Type", "application/json; charset=utf-8");
                ...
                for(var key0 in args.headers)if (({}).hasOwnProperty.call(args.headers, key0)) xhr.setRequestHeader(key0, args.headers[key0]);
    ...
    var _25 = function($window, mountRedraw00) {
        ...
        function setPath(path0, data, options) {
            ...
            if (fireAsync != null) {
                ...
                if (options && options.replace) $window.history.replaceState(state, title, route1.prefix + path0);
                else $window.history.pushState(state, title, route1.prefix + path0);
            } else $window.location.href = route1.prefix + path0;
        }
        var currentResolver = sentinel0, component, attrs31, currentPath, lastUpdate;
        ...
        function route1(root, defaultRoute, routes) {
            ...
            function resolveRoute() {
                ...
                var path0 = prefix.concat().replace(/(?:%[a-f89][a-f0-9])+/gim, decodeURIComponent).slice(route1.prefix.length);
                ...
                function loop(i) {
                    ...
                    for(; i < compiled.length; i++)if (compiled[i].check(data)) {
                        ...
                        var update = lastUpdate = function(comp) {
                            ...
                            attrs31 = data.params, currentPath = path0, lastUpdate = null;
            ...
            return mountRedraw00.mount(root, {
                ...
                view: function() {
                    ...
                    var vnode5 = [
                        Vnode(component, attrs31.key, attrs31)
                    ];
        ...
        route1.set = function(path0, data, options) {
            if (lastUpdate != null) {
                options = options || {};
        ...
        route1.Link = {
            view: function(vnode5) {
                ...
                if (child0.attrs.disabled = Boolean(child0.attrs.disabled)) {
                    ...
                    child0.attrs.href = route1.prefix + href;
                    child0.attrs.onclick = function(e) {
                        ...
                        result1 !== false && !e.defaultPrevented && (e.button === 0 || e.which === 0 || e.which === 1) && (!e.currentTarget.target || e.currentTarget.target === "_self") && // No modifier keys
        ...
        route1.param = function(key4) {
            return attrs31 && key4 != null ? attrs31[key4] : attrs31;
        };
        return route1;
    };
