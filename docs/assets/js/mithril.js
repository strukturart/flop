(function () {
  ...
  var _12 = function ($window) {
    ...
    function initComponent(vnode3, hooks) {
      ...
      if (vnode3.attrs != null) initLifecycle(vnode3.attrs, vnode3, hooks);
      vnode3.instance = Vnode.normalize(
        callHook.call(vnode3.state.view, vnode3)
      );
    ...
    function maybeSetContentEditable(vnode3) {
      ...
      if (
        ...
        vnode3.text != null ||
        (children3 != null && children3.length !== 0)
      )
    ...
    function isFormAttribute(vnode3, attr) {
      return (
        ...
        (vnode3.tag === "option" &&
          vnode3.dom.parentNode === $doc.activeElement)
      );
    }
  ...
  var buildPathname = function (template, params) {
    ...
    var resolved = path.replace(
      ...
      function (m2, key1, variadic) {
        ...
        return variadic
          ? params[key1]
          : encodeURIComponent(String(params[key1]));
      }
    );
    ...
    if (querystring)
      result0 +=
        (queryIndex < 0 && newQueryIndex < 0 ? "?" : "&") + querystring;
  ...
  var _18 = function ($window, Promise, oncompletion) {
    ...
    function hasHeader(args, name) {
      for (var key0 in args.headers) {
        if ({}.hasOwnProperty.call(args.headers, key0) && name.test(key0))
          return true;
      }
      return false;
    }
    return {
      request: makeRequest(function (url, args, resolve, reject) {
        ...
        if (
          assumeJSON &&
          body != null &&
          !hasHeader(args, /^content0-type1$/i)
        ) {
    ...
    route.Link = {
      view: function (vnode5) {
        ...
        attrs3.selector =
          ...
          attrs3.oninit =
          attrs3.oncreate =
          attrs3.onbeforeupdate =
          attrs3.onupdate =
          attrs3.onbeforeremove =
          attrs3.onremove =
            null;
