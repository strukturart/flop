...
function sendMessage(msg) {
    if (conn && conn.open) {
        if (settings.username != "") msg = "#" + settings.username + " " + msg;
        conn.send(msg);
        ...
        m.redraw();
    } else _helperJs.side_toaster("Connection is closed", 10000);
}
function ready() {
...
let create_peer = function() {
    ...
    peer.on("connection", function(c) {
        ...
        _helperJs.side_toaster("user connected", 3000);
        ready();
    });
    peer.on("disconnected", function() {
        console.log("Connection lost. Please reconnect");
...
let time_parse = function(value) {
    ...
    return t1.getDate() + " " + month[t1.getMonth()] + " " + t1.getFullYear() + ", " + t1.getHours() + ":" + t1.getMinutes();
};
...
},{"./assets/js/helper.js":"db1Xp","./assets/js/dummy-data.js":"gmFgS","peerjs":"6UUug","./assets/js/scan.js":"6auJa","minidenticons":"iNbej","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"db1Xp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
