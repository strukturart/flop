...
*/ !function(t, e) {
    ...
    function t1(t, e) {
        var n;
        return "function" == typeof Object.create ? n = Object.create(t) : (s1.prototype = t, n = new s1(), s1.prototype = null), e && i1(!0, n, e), n;
    }
    function e1(e, n, s, r) {
        var o = this;
        return "string" != typeof e && (r = s, s = n, n = e, e = null), "function" != typeof n && (r = s, s = n, n = function() {
            return o.apply(this, arguments);
        }), i1(!1, n, o, r), n.prototype = t1(o.prototype, s), n.prototype.constructor = n, n.class_ = e || o.class_, n.super_ = o, n;
    }
    function i1(t, e, i) {
        for(var n, s, a = 0, h = (i = o1.call(arguments, 2)).length; a < h; a++){
            s = i[a];
            for(n in s)t && !r1.call(s, n) || (e[n] = s[n]);
        }
    }
    function n1() {}
    var s1 = function() {}, r1 = Object.prototype.hasOwnProperty, o1 = Array.prototype.slice, a1 = e1;
    n1.class_ = "Nevis", n1.super_ = Object, n1.extend = a1;
    var h1 = n1, f1 = h1.extend(function(t, e, i) {
        ...
        draw: function(t) {
            var e, i, n = this.qrious, s = this.getModuleSize(t), r = this.getOffset(t), o = this.element.getContext("2d");
        ...
        _appendData: function(t, e, i, n) {
            ...
            for(r = 0; r < e; r++){
                if (255 !== (s = _.LOG[h[t + r] ^ h[i]])) for(o = 1; o < n; o++)h[i + o - 1] = h[i + o] ^ _.EXPONENT[v._modN(s + a[n - o])];
        ...
        _interleaveBlocks: function() {
            var t, e, i = this._dataBlock, n = this._ecc, s = this._eccBlock, r = 0, o = this._calculateMaxLength(), a = this._neccBlock1, h = this._neccBlock2, f = this._stringBuffer;
            for(t = 0; t < i; t++){
        ...
        _pack: function() {
            var t, e, i, n = 1, s = 1, r = this.width, o = r - 1, a = r - 1, h = (this._dataBlock + this._eccBlock) * (this._neccBlock1 + this._neccBlock2) + this._neccBlock2;
            for(e = 0; e < h; e++)for(t = this._stringBuffer[e], i = 0; i < 8; i++, t <<= 1){
                128 & t && (this.buffer[o + r * a] = 1);
                do s ? o-- : (o++, n ? 0 !== a ? a-- : (n = !n, 6 === (o -= 2) && (o--, a = 9)) : a !== r - 1 ? a++ : (n = !n, 6 === (o -= 2) && (o--, a -= 8))), s = !s;
    ...
    }), w = h1.extend(function(t2) {
        this.options = {}, t2.forEach(function(t) {
        ...
        _createAccessor: function(t, e, i) {
            ...
            t.modifiable && (n2.set = function(n) {
                w._set(t, n, e) && i(n, t);
            }), Object.defineProperty(e, t.name, n2);
        },
        _get: function(t, e) {
            return e["_" + t.name];
        },
        ...
        new g("value", !0, ""), 
    ]), y = new b(), O = h1.extend(function(t) {
        B.init(t, this, this.update.bind(this));
        var e = B.get("element", this), i = y.getService("element"), n = e && i.isCanvas(e) ? e : i.createCanvas(), s = e && i.isImage(e) ? e : i.createImage();
        this._canvasRenderer = new c1(this, n, !0), this._imageRenderer = new m(this, s, s === e), this.update();
    }, {
        get: function() {
