...
function setupVisualizer({ mode, srcNode, audioElement }) {
  ...
  console.log("test" + status.audioMotion);

  // 2️⃣ AudioMotion initialisieren oder wiederverwenden
  ...
  if (mode === "playback" && audioElement) {
    console.log("🎧 Playback visualizer aktiv");
